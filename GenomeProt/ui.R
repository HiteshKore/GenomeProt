      ...
      tabItem(tabName = "visualisation", 
              ...
              fluidRow(
                ...
                column(8,
                       ...
                       h5("Filter gene list for:"),
                       checkboxInput("uniq_map_peptides", "ORFs with uniquely mapped peptides", value = FALSE),
                       checkboxInput("lncRNA_peptides", "long non-coding RNAs", value = FALSE),
                       checkboxInput("novel_txs", "novel transcript isoforms", value = FALSE),
                       checkboxInput("unann_orfs", "unannotated ORFs", value = FALSE),
                       checkboxInput("uorf_5", "5' uORFs", value = FALSE),
                       checkboxInput("dorf_3", "3' dORFs", value = FALSE),
