...
get_transcript_orfs(filteredgtf="db_output/proteome_database_transcripts.gtf", organism=organism, orf_len=min_orf_length, find_UTR_orfs=find_orfs, referencegtf=reference_gtf)
