...
option_list = list(
  ...
  make_option(c("-s", "--species"), type = "character", default = NULL,
              help = "Organism: HUMAN / MOUSE / RAT / CAEEL / DROME / DANRE", metavar = "character"),
...
if (!file.exists(bam_dir)) {
  ...
  error_message <- paste0("Organism '", as.character(opt$species), "' is not supported. Please specify one of the following (case-insensitive): 'HUMAN', 'MOUSE', 'RAT', 'CAEEL' (C. elegans), 'DROME' (Drosophila), or 'DANRE' (Zebrafish).")
